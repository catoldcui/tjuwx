  ...
  <head>
    ...
    <s:iterator value="#session.letterlist" id="letter" status="st">
        <tr 
             ...
             >
        	<td><s:property value="%{#st.count + #session.pageNum * 10 - 10}"/></td>
    ...
    <center>
        ...
        <font size="5">当前第<font color="red"><s:property value="#session.pageNum"/></font>页</font>
        <font size="5">共<font color="red"><s:property value="#session.count"/></font>条记录</font>
